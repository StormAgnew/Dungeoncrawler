namespace RoomLibrary
{
    public class Room
    {
        ...
        public static Room GetRoom()
        {
            ...
            Room r2 = new Room("You enter a room that's rather bright. Almost TOO bright. It's decorated with child-like decorations, from stuffed animals to dollies. In the corner of the room, you see a small creature holding one of the stuffed animals. It appears to be a little girl, hair draping down to her knees. She appears to have been crying, as she looks up at you. Her face is badly bruised, and her lip appears to have been broken open.");
